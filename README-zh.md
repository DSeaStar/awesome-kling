...
> **可灵 Kling AI / Kling 3.0** 优质提示词、视频生成技巧、运动控制工作流与开发者资源的精选集合（快手可灵）。

本仓库专注于**高保真 Kling 提示词**：电影感、广告、UGC、动漫、短剧、特效，以及 **API / SDK / 生产工作流**，帮助你把可灵真正用到产品和内容流水线里。
...
欢迎贡献！如果你有**优秀的 Kling 提示词**、工作流或工具，请提交 Pull Request。
