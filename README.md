Last updated on 2026-08-08 12-00-00
...
2. [文生图（T2I）](#1-文生图t2i)
3. [提示词公式（从这里开始）](#2-提示词公式从这里开始)
4. [电影风格](#3-电影风格)
5. [广告与商业品牌](#4-广告与商业品牌)
6. [社交媒体与病毒模因](#5-社交媒体与病毒模因)
7. [UGC 风格](#6-ugc-风格)
8. [动漫与动画风格](#7-动漫与动画风格)
9. [短剧与网剧](#8-短剧与网剧)
10. [视觉特效与实验风格](#9-视觉特效与实验风格)
1. [运动控制与角色一致性](#10-运动控制与角色一致性)
...
1. Fork 本仓库
2. 新建分支
3. 在对应分类下添加提示词：**一律插到该节最前面**（最新优先，不要追加到末尾）
4. 小节编号顺延重排（新条目为 `X.1`，原 `X.1` 变为 `X.2`，以此类推）
5. 非原创请标注 **Source**（原作者链接）
6. 尽量写明**时长、分镜、运镜**（T2I 写明画幅与机位）
7. 同步更新 `README.md`（中文主页）与 `README-en.md`
8. 提交 PR
